...
module.exports = {
  activate() {
    this.subscription = inkdrop.commands.add(document.body, {
      'export-as-pure-markdown:all': () => this.exportAll(),
      'export-as-pure-markdown:selections': () => this.exportSelectedNotes(),
      'export-as-pure-markdown:notebook': e => this.exportBook(e)
    })
  },
